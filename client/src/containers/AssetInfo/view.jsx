      ...
      <div className='asset-info'>
        { description && (
          <RowLabeled
            ...
            content={<div className='asset-info__description'><ReactMarkdown className={'markdown-preview'} escapeHtml={escapeHtmlDescriptions} skipHtml={skipHtmlDescriptions} disallowedTypes={disallowedTypesDescriptions} source={description} /></div>}
          />
        )}
        {editable && (
          <RowLabeled
